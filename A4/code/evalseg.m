...
gt_dir = fullfile(DATA_DIR, 'train', 'gt_left');
...
if nargin < 2
   gt_filename = fullfile(DATA_DIR, 'train', 'train.txt');
...
for i=1:length(gtids)
    ...
    data = getData(imname, 'train', 'gt-left');
